class Mouse:
    ...
    def are_at_exit(self) -> bool:
        if ((self.maze[self.position[0] - 1][self.position[1]] == 'E') or
        (self.maze[self.position[0] + 1][self.position[1]] == 'E') or
        (self.maze[self.position[0]][self.position[1] - 1] == 'E') or
        (self.maze[self.position[0]][self.position[1] + 1] == 'E')):
            return True